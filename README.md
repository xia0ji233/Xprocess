...
本项目仅供 Windows 进程、DLL 注入原理学习、逆向分析研究、软件调试和安全测试等合法用途使用。请勿将本项目或其衍生代码用于游戏外挂、作弊、未授权注入、绕过安全机制、破坏他人系统或侵犯他人合法权益的行为。

项目作者未授权任何个人或组织将本项目用于游戏外挂、作弊工具、规避反作弊检测、恶意软件、商业化黑灰产工具或其他违法违规用途。任何第三方将本项目、项目名称、可执行文件、源码片段或衍生版本用于上述用途，均与项目作者无关。

本项目不为游戏外挂、作弊、反作弊绕过、未授权注入、免检测、隐藏模块、恶意持久化等用途提供技术支持、问题解答、功能适配或代码修改。相关 issue、PR、讨论或其他请求将被直接关闭或拒绝。

使用者应自行遵守所在国家和地区的法律法规，并在获得明确授权的环境中使用本项目。因使用、修改、传播本项目而产生的任何法律责任、经济损失或其他后果，均由使用者自行承担，项目作者不承担任何责任。
